...
export const About = () => {
  return (
    <section id="about" className="flex items-center justify-center py-16 px-8 max-w-[1200px] mx-auto">
      <div className="flex flex-col items-center">
        <h2 className="mb-6 text-(--color-primary) leading-[1.2] text-2xl font-bold">About Us</h2>
